...
export declare type Transform = ExtendedPluginBuilder | string | [string, unknown];
export declare type Options = Omit<SharedOptions, 'transforms' | 'compiler'> & {
    compilerPath?: string;
    compiler?: EmberTemplateCompiler;
    transforms?: Transform[];
};
declare const _default: ((babel: typeof import("@babel/core")) => import("@babel/core").PluginObj<unknown>) & {
    baseDir(): string;
    _parallelBabel: {
        requireFile: string;
    };
